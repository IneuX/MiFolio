      ...
      <div className="pt-32 pb-20 px-4 md:px-8 max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="mt-8">
            <Link
              href={`/${lang}/blog/new`}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium text-black bg-white hover:bg-gray-200 transition-colors hover:scale-105 transform duration-200"
            >
              <Plus size={16} />
              <span>{lang === "zh" ? "新建文章" : "New Post"}</span>
            </Link>
          </div>
        </div>
          ...
          {blogPosts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-white/40">
                {lang === "zh" 
                  ? "发布你的第一篇文章，开始分享你的想法。"
                  : "Publish your first post to start sharing your thoughts."
                }
              </p>
              <Link
                href={`/${lang}/blog/new`}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium text-black bg-white hover:bg-gray-200 transition-colors hover:scale-105 transform duration-200 mt-6"
              >
                <Plus size={16} />
                <span>{lang === "zh" ? "创建第一篇文章" : "Create First Post"}</span>
              </Link>
            </div>
          )}
        </div>
